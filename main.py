...
st.markdown("""
    ...
    .user-msg { background-color: #DCF8C6; padding: 10px; border-radius: 10px; max-width: 80%; margin-right: auto; }
    .ai-msg { background-color: #E6E6E6; padding: 10px; border-radius: 10px; max-width: 80%; margin-left: auto; }
